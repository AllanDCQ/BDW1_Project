<h2 class="subtitle is-3" style="color:#193051;">Tables</h2>
<div class="panneauTable">
  ...
  <div>  <!-- Premier bloc permettant l'affichage de la liste des tables -->
	...
	<table class="table is-striped table_resultat">
		<thead>
	...
	<?php foreach($tables as $t) { ?>
		<tr><td><?= UTILISATEUR. '.' . $t['table_name'] ?></td></tr>
	<?php } ?>
